...
Below is explanation of how the script was built and the workflow used. For details on specific analytic choices, refer to the respective functions in the `99_get_cohorts.R` script.
